...
document.addEventListener('DOMContentLoaded', function () {
  ...
  let selectedPopulation = '1000000'; // Значение по умолчанию: до 500 000 жителей
  let currentStep = stepValues.indexOf(9); // Значение по умолчанию: 12 месяцев
  ...
  function setDefaults() {
    selectedOption.textContent = 'Магазин';
    selectedPopulation = '1000000';

    currentStep = stepValues.indexOf(9);
